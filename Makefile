...
# Create completion scripts in the current directory
completions-generate: install
	@echo "Generating shell completions..."
	@mkdir -p completions
	$(POETRY) run $(BINARY_NAME) completion bash > completions/$(BINARY_NAME).bash
	$(POETRY) run $(BINARY_NAME) completion zsh > completions/$(BINARY_NAME).zsh
